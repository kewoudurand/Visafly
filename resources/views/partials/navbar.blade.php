...
<header id="vf-header" class="vf-header">
  <div class="vf-header-inner">
      ...
      <ul class="vf-nav-list">
        ...
        <li class="has-dropdown">
          ...
          <div class="vf-dropdown">
            ...
            {{-- ✅ AJOUT : Cours d'allemand --}}
            <a href="{{ route('cours.allemand.index') }}">
              <i class="bi bi-book me-2"></i>Cours d'allemand
            </a>
          </div>
        </li>
    ...
    <div class="vf-actions">
      ...
      {{-- ── NON CONNECTÉ ── --}}
      @guest
        <a href="{{ route('auth.register.show') }}" class="vf-btn-primary" id="signup-btn-desktop">
          Créer un compte
        </a>
        <a href="{{ route('login') }}" class="vf-btn-outline" id="login-btn-desktop">
          Se connecter
        </a>
      @endguest
      ...
      @auth
        ...
        <div class="vf-profile-menu">
          ...
          <div class="vf-profile-dropdown" id="profileDropdown">
            ...
            {{-- ✅ Dashboard selon le rôle — SANS route('student.index') qui n'existe pas --}}
            @if(Auth::user()->hasRole(['super-admin', 'admin', 'consultant']))
              ...
              <a href="{{ route('admin.analytics.index') }}" class="vf-dd-item">
                <i class="bi bi-bar-chart"></i> Analytics
              </a>
            @else
              <a href="{{ route('dashboard') }}" class="vf-dd-item">
                <i class="bi bi-speedometer2"></i> Mon espace
              </a>
            @endif

            {{-- ✅ Lien épreuves TCF : utilise la bonne route --}}
            @can('pass test')
            ...
            {{-- ✅ Cours d'allemand --}}
            <a href="{{ route('cours.allemand.index') }}" class="vf-dd-item">
              <i class="bi bi-book"></i> Cours d'allemand
            </a>
  ...
  <div class="vf-mobile-menu" id="vf-mobile-menu">
    <div class="vf-mobile-menu-inner">
      ...
      <div class="vf-mobile-dropdown" id="langMobileDropdown" style="display:none;">
        ...
        <a href="{{ route('cours.allemand.index') }}"     class="vf-mobile-subitem">🇩🇪 Cours d'allemand</a>
      </div>
...
@media(max-width:640px){
  ...
  .vf-icon-btn, .vf-avatar-btn{width:34px;height:34px;}
