{{-- resources/views/admin/analytics/langues.blade.php --}}
...
.bar-lbl{font-size:12px;color:#555;min-width:100px;text-align:right;flex-shrink:0;}r
...
<div class="row g-3 mb-4">
    <div class="col-6 col-md-3">
        <div class="kpi">
            <div class="kpi-num" style="color:#1B3A6B;">{{ $stats['total_passages'] }}</div>
            <div class="kpi-lbl">Passages totaux</div>
        </div>
    </div>
    <div class="col-6 col-md-3">
        <div class="kpi">
            <div class="kpi-num" style="color:#1cc88a;">{{ $stats['termines'] }}</div>
            <div class="kpi-lbl">Terminés</div>
        </div>
    </div>
    <div class="col-6 col-md-3">
        <div class="kpi">
            <div class="kpi-num" style="color:#F5A623;">{{ $stats['score_moyen'] }}%</div>
            <div class="kpi-lbl">Score moyen</div>
        </div>
    </div>
    <div class="col-6 col-md-3">
        <div class="kpi">
            <div class="kpi-num" style="color:#1B3A6B;">{{ $stats['ce_mois'] }}</div>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <span style="display:inline-flex;align-items:center;gap:4px;padding:3px 9px;
                                     ...
                                     background:{{ $p->langue->couleur }};color:#fff;">
                            {{ strtoupper($p->langue->code) }}
                        </span>
...
<div class="col-lg-4">
    ...
    <div class="an-card">
        ...
        @php $nb = $passagesParLangue[$langue->code] ?? 0; $pct = $stats['termines'] > 0 ? round($nb / max($stats['total_passages'], 1) * 100) : 0; @endphp
        <div class="bar-row">
            ...
            <div class="bar-track">
                <div class="bar-fill" style="width:{{ $pct }}%;background:{{ $langue->couleur }};"></div>
            </div>
    ...
    <div class="an-card">
        ...
        <div style="display:flex;align-items:center;gap:10px;margin-bottom:12px;">
            ...
            <div style="flex:1;">
                ...
                <div style="font-size:11px;color:#888;">{{ $etu->nb_passages }} passage(s)</div>
            </div>
